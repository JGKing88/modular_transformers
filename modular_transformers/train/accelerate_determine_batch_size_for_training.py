...
from accelerate import (Accelerator,
                        DeepSpeedPlugin)
from accelerate.utils import (LoggerType, DummyOptim, DummyScheduler,find_executable_batch_size)
...
if __name__ == "__main__":
    ...
    lr_scheduler = get_cosine_schedule_with_warmup(optimizer=optimizer,num_warmup_steps=100,num_training_steps=10000)
    inner_training_loop()
