...
def main():
    ...
    train_config = {"lr": 0.0006, "num_epochs": 17, "correct_bias": True, "batch_size": batch_size, "data": data}
    ...
    if (
        ...
        lr_scheduler = get_cosine_schedule_with_warmup(
            ...
            num_training_steps=(len(train_dataloader) * 25), #usually 25 should be num_epochs but we're cutting of early here
        )
    else:
        assert False
