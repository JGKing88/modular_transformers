...
def compare(num_perturbations, perturb_location):
    ...
    save_path = f"{path}/gpt-4_similarities_perturb_{num_perturbations}x_{perturb_location}.pkl"
    ...
    for multiplier in multipliers:
        ...
        for perturb_type in types:
            ...
            selected_gpt_embeddings = torch.index_select(gpt_embeddings, 0, torch.tensor(indices).to(device))
