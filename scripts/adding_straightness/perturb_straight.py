...
def generate_normal_sentences(data):
    ...
    for i in range(num_perturbations):
        ...
        normal_data, activations = generate_perturbed_token(model, normal_data, perturb_function = lambda input, hook: None)
...
def generate_sentences(data, perturb_location, size):
    ...
    for i in range(num_perturbations):
        ...
        straighter_data, activations = generate_perturbed_token(model, straighter_data, perturb_function)
        ...
        curved_data, activations = generate_perturbed_token(model, curved_data, perturb_function)
